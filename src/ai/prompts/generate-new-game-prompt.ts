...
## Task
Generate a game setting, tone, difficulty, and three initial plot hooks based on the player's request. Return ONLY a valid JSON object with proper markdown formatting.
...
## Required JSON Structure
{
  ...
  "initialHooks": [
      ...
      "Another one-sentence plot hook.",
      "A final one-sentence plot hook."
  ]
}
