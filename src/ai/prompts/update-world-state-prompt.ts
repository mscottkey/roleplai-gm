...
## YOUR TASK
Return a NEW, UPDATED world state object based on the rules below.
...
### 3. Background Progression (Faction Clocks) - NEW
...
- **Story Outline & Aspects**: Review the story outline. If this event completes a major objective, remove it. If a major new goal is created, add it. If a new, important story theme or concept was introduced, add it to `storyAspects`.
- **Scene & Location**:
