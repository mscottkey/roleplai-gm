export const generateSingleCharacterPromptText = `You are an expert game master creating a compelling character for a tabletop RPG based on the Fate Core system. Generate a unique character concept including skills and stunts.
...
- A core aspect that is a descriptive phrase about the character.
- The character's pronouns (e.g., "She/Her", "He/Him", "They/Them").
- An age (e.g., "Young Adult", "Middle-Aged", "Elderly", "Ancient").
- An archetype or role (e.g., "Investigator", "Warrior", "Diplomat", "Sorcerer").
