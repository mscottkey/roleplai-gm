export const estimateCostPromptText = `You are an expert AI cost analyst for a tabletop RPG application that uses large language models. Your task is to estimate the token usage and cost for a typical game session based on the provided game data.
